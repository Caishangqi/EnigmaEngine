...
TEST(VTBackendTest, Standard_Black)
{
	EXPECT_EQ(MapColorTo256(FColor(0, 0, 0)), 0);
}

TEST(VTBackendTest, Standard_White)
{
	EXPECT_EQ(MapColorTo256(FColor(255, 255, 255)), 15);
}

TEST(VTBackendTest, Standard_Red)
{
	EXPECT_EQ(MapColorTo256(FColor(255, 0, 0)), 9);
}

TEST(VTBackendTest, Standard_Green)
{
	EXPECT_EQ(MapColorTo256(FColor(0, 255, 0)), 10);
}

TEST(VTBackendTest, Standard_Blue)
{
	EXPECT_EQ(MapColorTo256(FColor(0, 0, 255)), 12);
}
...
TEST(VTBackendTest, Cube_Origin)
{
...
TEST(VTBackendTest, Cube_95_95_95)
{
	// Cube (1,1,1) = 16 + 36 + 6 + 1 = 59
	// vs standard gray (128,128,128) dist = 33*3 = 3267
	// vs cube (95,95,95) dist = 0
	EXPECT_EQ(MapColorTo256(FColor(95, 95, 95)), 59);
}

TEST(VTBackendTest, Cube_255_255_0)
{
	// Standard yellow (11) = (255,255,0) exact match.
	EXPECT_EQ(MapColorTo256(FColor(255, 255, 0)), 11);
}

TEST(VTBackendTest, Cube_135_175_215)
{
...
TEST(VTBackendTest, Grayscale_MidGray)
{
	// Gray value 128 -> gi = (128-8)/10 = 12 -> grayVal = 128
	// Index = 232 + 12 = 244
	// vs standard gray (128,128,128) index 8, dist = 0
	// Standard wins with exact match.
	EXPECT_EQ(MapColorTo256(FColor(128, 128, 128)), 8);
}

TEST(VTBackendTest, Grayscale_DarkGray_38)
{
	...
	// Grayscale wins.
	EXPECT_EQ(MapColorTo256(FColor(38, 38, 38)), 235);
}

TEST(VTBackendTest, Grayscale_LightGray_218)
{
	...
	EXPECT_EQ(MapColorTo256(FColor(218, 218, 218)), 253);
}
