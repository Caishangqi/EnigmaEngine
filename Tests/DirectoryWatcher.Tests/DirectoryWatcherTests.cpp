...
// ---------------------------------------------------------------
TEST_F(DirectoryWatcherTest, RegisterCallback_Success)
{
...
// ---------------------------------------------------------------
TEST_F(DirectoryWatcherTest, UnregisterCallback_Success)
{
    IDirectoryWatcher::FDirectoryChanged Callback;
...
// DetectFileAdd
// ---------------------------------------------------------------
TEST_F(DirectoryWatcherTest, DetectFileAdd)
{
    std::vector<FFileChangeData> Received;
    IDirectoryWatcher::FDirectoryChanged Callback;
    Callback.Bind([&Received](const std::vector<FFileChangeData>& Changes)
...
// DetectFileModify
// ---------------------------------------------------------------
TEST_F(DirectoryWatcherTest, DetectFileModify)
{
    // Pre-create the file.
    ...
    EXPECT_TRUE(FoundModify);
}

// ---------------------------------------------------------------
// DetectFileRemove
// ---------------------------------------------------------------
TEST_F(DirectoryWatcherTest, DetectFileRemove)
{
    // Pre-create the file.
...
// ---------------------------------------------------------------
TEST_F(DirectoryWatcherTest, MultipleWatchers_SameDirectory)
{
    ...
    EXPECT_FALSE(ReceivedA.empty());
    EXPECT_FALSE(ReceivedB.empty());
}

// ---------------------------------------------------------------
// UnregisterCallback_NoMoreNotifications
// ---------------------------------------------------------------
TEST_F(DirectoryWatcherTest, UnregisterCallback_NoMoreNotifications)
{
    std::vector<FFileChangeData> Received;
    IDirectoryWatcher::FDirectoryChanged Callback;
    Callback.Bind([&Received](const std::vector<FFileChangeData>& Changes)
