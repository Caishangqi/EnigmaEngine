...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, Opaque_ReplacesAll)
{
	...
	TestEqual("EXPECT_EQ", result.Character, '@');
	TestEqual("EXPECT_EQ", result.Foreground, FColor::Red);
	TestEqual("EXPECT_EQ", result.Background, FColor::Blue);
}
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, Add_ClampsTo255)
{
	...
	FAsciiCell result = RasterizeOne(dst, cmd);
	TestEqual("EXPECT_EQ", result.Foreground, FColor(255, 255, 255));
	TestEqual("EXPECT_EQ", result.Background, FColor(255, 255, 255));
}
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, Multiply_ScalesCorrectly)
{
	...
	TestEqual("EXPECT_EQ", result.Foreground, FColor(128, 128, 0));
	TestEqual("EXPECT_EQ", result.Background, FColor(128, 128, 0));
}
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, KeepNonSpace_PreservesExisting)
{
	...
	FAsciiCell result = RasterizeOne(dst, cmd);
	TestEqual("EXPECT_EQ", result.Character, '@'); // dst non-space preserved
}

ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, KeepNonSpace_OverwritesSpace)
{
	FAsciiCell dst{' ', FColor::White, FColor::Black};
	FDrawCommand cmd;
	cmd.Type = EDrawCommandType::Cell;
	...
	FAsciiCell result = RasterizeOne(dst, cmd);
	TestEqual("EXPECT_EQ", result.Character, '#'); // dst was space, overwritten
}
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, CustomLambda_Foreground)
{
	...
	FAsciiCell result = RasterizeOne(dst, cmd);
	TestEqual("EXPECT_EQ", result.Foreground, FColor(55, 60, 65));
}
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, PerCommandBlend_DifferentStates)
{
	FAsciiBackBuffer buf;
	buf.Allocate(10, 10);
	...
	TestEqual("EXPECT_EQ", result.Foreground, FColor(150, 0, 0));
}
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, WriteMask_CharFalse_PreservesChar)
{
	FAsciiCell dst{'@', FColor::White, FColor::Black};
	FDrawCommand cmd;
	cmd.Type = EDrawCommandType::Cell;
	...
	FAsciiCell result = RasterizeOne(dst, cmd);
	TestEqual("EXPECT_EQ", result.Character, '@'); // preserved
	TestEqual("EXPECT_EQ", result.Foreground, FColor::Red); // written
	TestEqual("EXPECT_EQ", result.Background, FColor::Blue); // written
}
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, WriteMask_FgBgFalse_PreservesColors)
{
	...
	FAsciiCell result = RasterizeOne(dst, cmd);
	TestEqual("EXPECT_EQ", result.Character, 'X'); // written
	TestEqual("EXPECT_EQ", result.Foreground, FColor(10, 20, 30)); // preserved
	TestEqual("EXPECT_EQ", result.Background, FColor(40, 50, 60)); // preserved
}
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, WriteMask_AllFalse_NoChange)
{
	FAsciiCell dst{'@', FColor(10, 20, 30), FColor(40, 50, 60)};
	FDrawCommand cmd;
	cmd.Type = EDrawCommandType::Cell;
	...
	FAsciiCell result = RasterizeOne(dst, cmd);
	TestEqual("EXPECT_EQ", result, dst);
}
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, Chainable_TransparentWithAddFg)
{
	auto state = FAsciiBlendState::Transparent().WithForeground(EBlendOp::Add);
	TestEqual("EXPECT_EQ", state.CharacterOp, ECharBlendOp::KeepNonSpace);
	TestEqual("EXPECT_EQ", state.ForegroundOp, EBlendOp::Add);
	TestEqual("EXPECT_EQ", state.BackgroundOp, EBlendOp::Replace);
}
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, Chainable_OpaqueWriteBgOnly)
{
	FAsciiCell dst{'@', FColor(10, 20, 30), FColor(40, 50, 60)};
	FDrawCommand cmd;
	cmd.Type = EDrawCommandType::Cell;
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, Equality_SamePresets)
{
	TestEqual("EXPECT_EQ", FAsciiBlendState::Opaque(), FAsciiBlendState::Opaque());
	TestEqual("EXPECT_EQ", FAsciiBlendState::Transparent(), FAsciiBlendState::Transparent());
	TestEqual("EXPECT_EQ", FAsciiBlendState::Additive(), FAsciiBlendState::Additive());
}

ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, Equality_DifferentPresets)
{
	TestNotEqual("EXPECT_NE", FAsciiBlendState::Opaque(), FAsciiBlendState::Transparent());
	TestNotEqual("EXPECT_NE", FAsciiBlendState::Opaque(), FAsciiBlendState::Additive());
}

ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, Equality_WriteMaskDifference)
{
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, Equality_CustomFnNullptrState)
{
	auto a = FAsciiBlendState::Opaque();
...
ENIGMA_IMPLEMENT_ASCII_RENDERER_AUTOMATION_TEST(BlendStateTest, Equality_BothCustomFnNonNull)
{
	auto a = FAsciiBlendState::Opaque();
